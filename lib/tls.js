...
function SecurePair(credentials, isServer, requestCert, rejectUnauthorized,
  ...
  if (options.pskCallback) {
    this.ssl.setPskClientCallback(options.pskCallback);
  }
...
exports.connect = function(/* [port, host], options, cb */) {
  ...
  var isPsk = !!(options.pskIdentity && options.pskKey);
  ...
  if (isPsk) {
    ...
    var hascb = options.pskClientCallback ? true : false;
    if (!hascb) {
  ...
  var pair = new SecurePair(sslcontext, false, true,
                            options.rejectUnauthorized === true ? true : false,
                            {
                              ...
                              pskCallback : options.pskClientCallback
                            });
